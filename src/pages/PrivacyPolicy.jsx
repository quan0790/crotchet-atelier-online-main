...
const sections = [
  {
    ...
    description:
      'We collect personal information you provide directly, such name, email, phone number, shipping address, and order details including customizations and payment info.',
  },
  {
    icon: Settings,
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Your privacy matters. This page explains how we collect, use, and protect your information.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {sections.map((section) => (
            <div
              key={section.title}
              className="flex gap-4 p-6 bg-card rounded-2xl shadow-md hover:shadow-lg transition-shadow"
            >
